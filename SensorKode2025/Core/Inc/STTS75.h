...
//hvis alle pinnene er koblet til jord:
//#define STTS75_I2C_ADDR ( 0x48U << 1) // A0 ,A1 A2 = GND

//hvis alle pinnene er koblet til VDD:
#define STTS75_I2C_ADDR (0x4FU << 1) // A0 ,A1 A2 = VDD

#define STTS75_WRITE (STTS75_I2C_ADDR & 0xFEU)
